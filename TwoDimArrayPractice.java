...
public class TwoDimArrayPractice extends JFrame
{
    ...
    // Write your code here:
	   for(int r = 0; r < intArray.length; r++) {
		   for(int c = 0; c < intArray[r].length; c++)
			   System.out.println(intArray[r][c]);
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
	   String strRow = JOptionPane.showInputDialog("Enter row number 0 to 3: ");
	   row = Integer.parseInt(strRow);
	   
	   String strValue = JOptionPane.showInputDialog("Enter a value between 50 and 80: ");
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   String stringColumn = JOptionPane.showInputDialog("Enter a column number: ");
	   column = Integer.parseInt(stringColumn);
	   
	   int min = 81;
	   for(int r = 0; r < intArray.length; r++) {
		   if(min > intArray[r][column]) {
			   min = intArray[r][column];
		   }
		 
	   }
	   
	   JOptionPane.showMessageDialog(null, "On column " + column + " the lowest value is " + min);
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   ...
	   JOptionPane.showMessageDialog(null, "The frequency of " + value + " is " + counter);
